# # 控制demo
# image = 'auction_icon.png'
# pyautogui.screenshot("temp/_temp_screen_shot.png")
# result = pyautogui.locateOnScreen(image, grayscale=False, confidence=0.6)
# if result is not None:
#     print("找到了")
#     left, top, width, height = result  # 提取位置信息
#     target_x = left + width / 2  # 计算目标位置的x坐标
#     target_y = top + height / 2  # 计算目标位置的y坐标
#     print(f"识别到的x,yw为：{target_x},{target_y}")
#     pyautogui.moveTo(target_x, target_y,duration=3)  # 将鼠标移动到目标位置
#     print("移动了")
